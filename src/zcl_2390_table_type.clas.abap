CLASS zcl_2390_table_type DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_2390_table_type IMPLEMENTATION.
...
*    DATA addresses TYPE tt_addresses.
    DATA addresses TYPE z2390t_addresses.
...
*  DATA person TYPE st_person_deep.
    DATA person TYPE z2390s_person_deep.
...
* DATA persons TYPE tt_persons.
 DATA persons TYPE z2390t_persons.
